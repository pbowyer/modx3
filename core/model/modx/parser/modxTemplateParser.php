...
class modxTemplateParser implements modTemplateParser
{
    ...
    {
        $this->modx->parser->processElementTags($this->parentTag, $content, $this->processUncacheable, $this->removeUnprocessed, $this->prefix, $this->suffix, $this->tokens, $this->depth);
        return $content;
    }
